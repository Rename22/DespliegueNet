<%@ Page Title="Agregar Perfil" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AgregarPerfil.aspx.cs" Inherits="Ejercicio_2.AgregarPerfil" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1 class="text-center mb-4">Agregar Perfil</h1>
    <div class="mb-3">
